...
def main():
  ...
  plistpath = scriptpath + "/resources/AutoTalent-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AutoTalent-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AutoTalent-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AutoTalent-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AutoTalent-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AutoTalent-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/AutoTalent-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/AutoTalent.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/AutoTalent.iss",inplace=1):
