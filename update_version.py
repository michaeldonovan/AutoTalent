...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright michaeldonovan, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/AutoTalent-MD-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AutoTalent-MD-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AutoTalent-MD-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AutoTalent-MD-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AutoTalent-MD-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AutoTalent-MD-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/AutoTalent-MD-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/AutoTalent-MD.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/AutoTalent-MD.iss",inplace=1):
