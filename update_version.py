...
def main():
  ...
  plistpath = scriptpath + "/resources/AutoTalentMD-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AutoTalentMD-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AutoTalentMD-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AutoTalentMD-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AutoTalentMD-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AutoTalentMD-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/AutoTalentMD-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/AutoTalentMD.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/AutoTalentMD.iss",inplace=1):
